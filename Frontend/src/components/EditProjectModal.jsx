...
const EditProjectModal = ({ isOpen, onClose, project, onProjectUpdated }) => {
  ...
  return (
    ...
    >
      <div className="max-h-[95vh] w-full max-w-6xl overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-2xl">
        <div className="border-b border-slate-200 bg-gradient-to-r from-amber-50 via-orange-50 to-yellow-50 px-6 py-5 md:px-8">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm text-slate-600 md:text-base">
                Refine your project information, expand academic details, and keep
        ...
        <form onSubmit={handleSubmit} className="max-h-[calc(95vh-110px)] overflow-y-auto">
          <div className="grid gap-8 px-6 py-6 md:grid-cols-12 md:px-8">
              ...
              <section className="rounded-2xl border border-slate-200 bg-slate-50/70 p-5">
                ...
                <div className="mt-4 flex flex-col gap-3 md:flex-row">
                  <input
                    ...
                    className="flex-1 rounded-2xl border border-slate-300 bg-white px-4 py-3 outline-none transition placeholder:text-slate-400 focus:border-amber-500 focus:ring-4 focus:ring-amber-100"
                  />
                  <button
                    type="button"
              ...
              <section className="rounded-2xl border border-slate-200 bg-slate-50/70 p-5">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="rounded-2xl bg-amber-600 px-5 py-3 font-medium text-white hover:bg-amber-700"
                  >
                    Add
                  </button>
                </div>
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-slate-200 bg-white px-6 py-5 md:flex-row md:items-center md:justify-end md:px-8">
            <button
              type="button"
              onClick={onClose}
