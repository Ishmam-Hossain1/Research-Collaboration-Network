          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm text-slate-600 md:text-base">
                Build a complete project entry with academic context, timeline,
                methods, keywords, and expected impact.
              </p>
            </div>
                  ...
                  <div className="space-y-5">
                    <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4">
                      ...
                      <div className="mt-1 text-sm text-slate-600">
                        Progress will start at 0% and update automatically as
                ...
                <section className="rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-50 to-slate-50 p-5">
                  ...
                  <div className="mt-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <div className="mt-4 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-3 text-sm text-slate-600">
                      Progress will be calculated automatically from completed
                      milestones.
                    </div>
                  </div>
                </section>
