            ...
            {researchers.map((researcher) => {
              ...
              const isCollaborator =
                researcher.collaborators?.some(
                  (collaboratorId) =>
                    collaboratorId?.toString?.() === storedUser?.id
                ) || false;
              ...
              return (
                <Link
                  ...
                  className="researcher-card-link"
                >
                  <article className="relative researcher-card rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:-translate-y-1 hover:shadow-md transition">
