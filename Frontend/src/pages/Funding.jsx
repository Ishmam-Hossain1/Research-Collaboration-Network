...
//           showDeleteModal || showDeleteSuccessPopup || showCreateFunding ? "blur-sm" : ""
//         }`}
//       >
...
//         <section className="relative z-10 mt-20 w-full px-4 py-16 sm:px-6 lg:px-10">
...
//                     <div className="absolute left-[58%] top-8 hidden h-px w-[84%] bg-slate-300 md:block" />
//                   )}

//                   <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 text-2xl font-bold text-white shadow-[0_12px_28px_rgba(37,99,235,0.30)] transition duration-300 group-hover:scale-110 group-hover:bg-blue-700 group-hover:shadow-[0_18px_36px_rgba(37,99,235,0.38)]">
//                     {item.step}
//                   </div>
...
//       <div
//         className={`relative min-h-screen overflow-hidden bg-[#f3f6fb] px-4 py-8 sm:px-6 lg:px-10 ${
//           showDeleteModal || showDeleteSuccessPopup || showCreateFunding
//             ? "blur-sm"
//             : ""
//         }`}
//       >
...
//               <div className="mt-8 overflow-hidden rounded-[26px] border border-blue-100 bg-gradient-to-b from-blue-50 via-white to-white p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)]">
...
//                       {index !== fundingSteps.length - 1 && (
//                         <div className="absolute left-5 top-11 h-[calc(100%+10px)] w-px bg-blue-200" />
//                       )}

//                       <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-600 text-sm font-black text-white shadow-[0_10px_22px_rgba(37,99,235,0.25)]">
//                         {item.step}
//                       </div>
