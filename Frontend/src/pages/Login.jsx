...
//             <div className="max-w-md rounded-3xl border border-white/30 bg-white/20 p-8 text-slate-800 shadow-2xl backdrop-blur-md">
//               <div className="mb-4 inline-flex rounded-full bg-white/50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-blue-700">
//                 Research Connect
//               </div>
